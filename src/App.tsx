...
const TEAM = [
  ...
  },
  {
    ...
    formation: [
      "Graduação em Medicina - UFAM - Manaus/AM",
      "Residência em Ginecologia e Obstetrícia - Hospital Ministro Costa Cavalcanti - PR",
      "Residência em Medicina Fetal - Unicamp - SP",
      "Título de especialista em Medicina Fetal - FEBRASGO (Federação Brasileira das Associações de Ginecologia e Obstetrícia)",
      "Especialização em Ultrassonografia em Ginecologia e Obstetrícia - Unicamp - SP",
      "Título de especialista em Ultrassonografia em Ginecologia e Obstetrícia - CBR (Colégio Brasileiro de Radiologia)",
      "Especialização em Ultrassonografia e Biópsia de Mamas - Unicamp - SP",
      "CRM PR 41840 | RQE 29881 | RQE 37721 | RQE 93387"
    ]
  },
  {
...
export default function App() {
  ...
  const whatsappLink = "https://wa.me/5511956887648?text=Olá,%20gostaria%20de%20agendar%20uma%20consulta%20na%20Vitalis.";
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">(11) 95688-7648</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
            <img 
              ...
              referrerPolicy="no-referrer"
            />
            <p className="text-sm text-gray-500">© {new Date().getFullYear()} Vitalis Centro de Especialidades. Todos os direitos reservados.</p>
